...
export default function ModernShopLayout({
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900 font-sans selection:bg-primary selection:text-black pt-20">
      {/* SHOP HEADER */}
      <header className="bg-neutral-900/30 border-b border-black/10 pt-20 pb-12 px-6 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-neutral-600 max-w-lg mx-auto text-lg">
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-12 flex flex-col md:flex-row gap-8 items-start relative z-10">
        ...
        <aside className="w-full md:w-64 flex-shrink-0 md:sticky md:top-24 space-y-8">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 bg-white/50 border-black/10 text-neutral-900 placeholder:text-neutral-500 focus:border-primary/50 transition-colors h-11 rounded-xl"
              value={searchQuery}
              ...
              <button
                ...
                className={cn(
                  ...
                  activeCollection === null
                    ...
                    : "text-neutral-600 hover:bg-black/5 hover:text-neutral-900 border border-transparent"
                )}
              >
                All Products
              </button>
            ...
            <Badge
              ...
              className={cn(
                ...
                activeCollection === null
                  ...
                  : "text-neutral-600 border-black/10 hover:bg-black/5 hover:text-neutral-900"
              )}
              onClick={() => setActiveCollection(null)}
            >
              All
        ...
        <div className="flex-1 w-full">
          {filteredProducts.length === 0 ? (
            <div className="text-center py-24 border-2 border-dashed border-black/10 rounded-2xl bg-neutral-900/30">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredProducts.map((product) => (
                <Link
                  ...
                  className="group flex flex-col bg-neutral-900/50 border border-black/10 rounded-2xl overflow-hidden hover:border-primary/50 hover:shadow-[0_0_30px_rgba(var(--primary),0.1)] transition-all duration-300"
                >
                  <div className="aspect-[4/3] bg-white/50 relative overflow-hidden">
                    ...
                    <div className="absolute top-3 right-3 flex flex-col gap-2 items-end">
                      <Badge className="bg-black/70 backdrop-blur-md text-neutral-900 border-black/10 font-bold px-3 py-1 text-sm shadow-xl">
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <h3 className="font-bold text-xl leading-tight mb-2 group-hover:text-primary transition-colors text-neutral-900 line-clamp-2">
                      {product.title}
                    </h3>
                    <p className="text-sm text-neutral-600 line-clamp-2 mt-auto leading-relaxed">
                      {product.description}
                    </p>
                  </div>
                </Link>
