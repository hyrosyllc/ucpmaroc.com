import{r as a,j as e,G as n,X as l,U as d,Y as g,F as f,_ as c}from"./index-DOocgpZq.js";import{S as m}from"./shield-BS-zM3w8.js";import{A as y}from"./alert-circle-BigfrG3L.js";import{F as b}from"./file-text-Ce0GBqbM.js";import{D as v}from"./database-BGh4uOSQ.js";import{E as j}from"./eye-4n4EL8ZY.js";import{C as w}from"./clock-BQU4Bs1G.js";const U=()=>{const[u,o]=a.useState([]);a.useEffect(()=>{(()=>{const i=[];for(let r=0;r<30;r++)i.push({id:r,x:Math.random()*100,y:Math.random()*100,size:Math.random()*3+1,speedX:(Math.random()-.5)*.3,speedY:(Math.random()-.5)*.3});o(i)})();const x=setInterval(()=>{o(i=>i.map(r=>({...r,x:(r.x+r.speedX+100)%100,y:(r.y+r.speedY+100)%100})))},100);return()=>clearInterval(x)},[]);const p=[{icon:b,title:"Information We Collect",content:`The types of personal information we obtain about you depend on how you interact with our Site and use our Services. When we use the term "personal information", we are referring to information that identifies, relates to, describes or can be associated with you.
