    ...
    <section className="relative py-24 px-4 bg-neutral-950 overflow-hidden min-h-screen">
      ...
      <div className="container max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16 space-y-4">
          ...
          <InlineEdit
            tagName="p"
            className="text-neutral-400 text-lg max-w-2xl mx-auto block"
            text={
              data.subheadline ||
        ...
        {!hasServices && isPreview ? (
          <div className="w-full py-24 border-2 border-dashed border-white/10 rounded-3xl flex flex-col items-center justify-center text-white/50 bg-white/5">
                      ...
                      >
                        {service.demos.map((demo) => (
                          <div key={demo.demo_id}>
                            ...
                            <div
                              className={cn(
                                "rounded-xl overflow-hidden border border-white/5 bg-black/20 hover:border-white/20 transition-colors",
