...
const CheckoutLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white flex flex-col relative pt-20 md:pt-24 font-sans selection:bg-primary selection:text-black dark" data-theme="modern">
      ...
      */}
      <div className="w-full max-w-6xl mx-auto px-4 py-6 md:px-8 flex justify-between items-center border-b border-white/10 relative z-10">
        <Link
          to={shopUrl}
        ...
        <div className="flex items-center gap-2 text-sm font-bold text-white bg-white/5 border border-white/10 px-4 py-1.5 rounded-full backdrop-blur-md shadow-sm">
      ...
      */}
      <footer className="py-8 border-t border-white/10 bg-neutral-950/50 backdrop-blur-md text-center text-sm text-neutral-500 relative z-10">
