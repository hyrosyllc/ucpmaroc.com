import{r as a,j as e,G as n,v as l,U as d,w as g,x as y,y as c,z as f}from"./index-BOzflGaB.js";import{S as m}from"./shield-CWyTaYGj.js";import{A as b}from"./alert-circle-B-jnFCuE.js";import{F as v}from"./file-text-DV1uOl4M.js";import{D as w}from"./database-BHLcZTay.js";import{E as j}from"./eye-DzPdZBM_.js";const I=()=>{const[u,o]=a.useState([]);a.useEffect(()=>{(()=>{const i=[];for(let r=0;r<30;r++)i.push({id:r,x:Math.random()*100,y:Math.random()*100,size:Math.random()*3+1,speedX:(Math.random()-.5)*.3,speedY:(Math.random()-.5)*.3});o(i)})();const x=setInterval(()=>{o(i=>i.map(r=>({...r,x:(r.x+r.speedX+100)%100,y:(r.y+r.speedY+100)%100})))},100);return()=>clearInterval(x)},[]);const h=[{icon:v,title:"Information We Collect",content:`The types of personal information we obtain about you depend on how you interact with our Site and use our Services. When we use the term "personal information", we are referring to information that identifies, relates to, describes or can be associated with you.
