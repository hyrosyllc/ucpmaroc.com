...
const ThankYouLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white flex flex-col relative pt-20 md:pt-24 font-sans selection:bg-primary selection:text-black dark print:bg-white print:text-black print:pt-0" data-theme="modern">
