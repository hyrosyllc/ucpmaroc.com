...
const Hero: React.FC<any> = ({ data, settings = {}, id, isPreview }) => {
  ...
  const c1 = data.gradientColor1 || "#f8fafc";
  const c2 = data.gradientColor2 || "#e0e7ff";
  ...
  return (
    <>
      ...
      <section
        ref={heroRef}
        className="relative min-h-[100dvh] flex flex-col justify-center overflow-hidden bg-white text-neutral-900"
      >
        ...
        <div className="absolute inset-0 z-0">
          ...
          activeImage ? (
            ...
            /* DEFAULT FALLBACK */
            <div className="absolute inset-0 bg-white bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-neutral-200 to-white" />
          )}

          {/* Gradient Overlay */}
          <div
            className="absolute inset-0 bg-gradient-to-b from-white/30 via-white/50 to-white"
        ...
        >
          ...
          >
            ...
            <InlineEdit
              tagName="h1"
              className={cn(
                "text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[1.1] md:leading-[1.1] text-transparent bg-clip-text bg-gradient-to-b from-neutral-900 to-neutral-600 drop-shadow-sm will-change-transform block",
            ...
            <InlineEdit
              tagName="p"
              className="text-lg md:text-2xl text-neutral-700 font-light leading-relaxed max-w-2xl text-shadow-sm block"
              ...
              >
                ...
                {data.secondaryCtaText && (
                  <Button
                    ...
                    size="lg"
                    variant="outline"
                    className="h-14 md:h-16 px-8 md:px-10 rounded-full border-black/20 bg-black/5 hover:bg-black/5 text-neutral-900 backdrop-blur-sm text-base md:text-lg transition-all hover:scale-105"
                  >
            ...
            {data.showTrustBadge && data.trustText && (
              ...
              >
                <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-black/5 border border-black/10 backdrop-blur-sm shadow-xl">
        ...
        <div className="absolute bottom-8 left-0 right-0 z-20 flex justify-center animate-bounce-slow opacity-70">
          <a
            href="#content"
            className="flex flex-col items-center gap-2 text-neutral-500 hover:text-neutral-900 transition-colors cursor-pointer"
          >
